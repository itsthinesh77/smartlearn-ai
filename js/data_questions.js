...
// JAVA PROGRAMMING
'uj1': [
  {q:'Which structure is used in breadth-first traversal?',o:['Stack','Queue','Heap','Tree'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is method overloading?',o:['Same method different class','Same name different parameters','Different name same parameters','None'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used to prevent method overriding?',o:['static','final','const','abstract'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is JVM?',o:['Java Variable Machine','Java Virtual Machine','Java Verified Machine','None'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which exception is unchecked?',o:['IOException','SQLException','NullPointerException','InterruptedException'],c:2,e:'Correct logic implemented.',d:'medium'},
  {q:'What is inheritance?',o:['Code reuse','Data hiding','Encapsulation','None'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used for interface?',o:['class','interface','implements','extends'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is output?\nSystem.out.println(10/3);',o:['3.33','3','4','Error'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which collection allows duplicates?',o:['Set','Map','List','None'],c:2,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used for abstraction?',o:['abstract','static','final','private'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'What is constructor?',o:['Special method','Variable','Class','Loop'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used to implement interface?',o:['extends','implements','inherit','interface'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is output?\nSystem.out.println("Hello"+5+5);',o:['Hello10','Hello55','10Hello','Error'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used to call superclass constructor?',o:['this','super','base','parent'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which collection is ordered?',o:['Set','List','Map','None'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is encapsulation?',o:['Wrapping data and methods','Inheritance','Loop','Function'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which class is parent of all classes?',o:['Object','Class','Main','String'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'What is output?\nSystem.out.println(5+5+"Hello");',o:['10Hello','Hello10','55Hello','Error'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which keyword is used for thread?',o:['thread','Runnable','process','execute'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which operator is used for instanceof?',o:['instanceof','is','type','check'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which collection uses key-value pair?',o:['List','Set','Map','Array'],c:2,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the output?\nSystem.out.println(1 + 2 + "3" + 4 + 5);',o:['3345','3345','3345','3345'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println("3" + 4 + 5);',o:['12','345','39','9'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'Which exception is thrown when dividing by zero (int)?',o:['IOException','ArithmeticException','NullPointerException','RuntimeException'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nint x=5; System.out.println(x++ + ++x);',o:['11','12','Undefined','13'],c:3,e:'Correct logic implemented.',d:'hard'},
  {q:'Which method cannot be overridden?',o:['static','final','private','All'],c:3,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(10 + 20 + "Java" + 10 + 20);',o:['30Java1020','Java301020','30Java30','Error'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which keyword is used to stop inheritance?',o:['static','final','const','abstract'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(true && false || true);',o:['true','false','Error','Undefined'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which class is immutable?',o:['String','StringBuilder','StringBuffer','All'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(5 > 3 ? 10 : 20);',o:['10','20','Error','None'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which keyword is used for runtime polymorphism?',o:['static','final','override','virtual'],c:2,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println("A" + 1 + 2);',o:['A12','A3','3A','Error'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which interface is used for threads?',o:['Thread','Runnable','Process','Executor'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(10 * 20 + "Java");',o:['200Java','Java200','30Java','Error'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which block always executes?',o:['try','catch','finally','throw'],c:2,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(5 + "5" + 5);',o:['15','555','105','Error'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'Which keyword is used to throw exception?',o:['throws','throw','try','catch'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println(10 == 10.0);',o:['true','false','Error','Undefined'],c:0,e:'Correct logic implemented.',d:'hard'},
  {q:'Which collection does not allow duplicates?',o:['List','Set','Map','Array'],c:1,e:'Correct logic implemented.',d:'hard'},
  {q:'What is the output?\nSystem.out.println((10 > 5) ? "Yes" : "No");',o:['Yes','No','Error','None'],c:0,e:'Correct logic implemented.',d:'hard'},
...
// DATA STRUCTURES
'uds1': [
  {q:'Which data structure uses FIFO?',o:['Stack','Queue','Tree','Graph'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which data structure uses LIFO?',o:['Queue','Stack','Array','Linked List'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which data structure stores elements in contiguous memory?',o:['Linked List','Array','Tree','Graph'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which is a linear data structure?',o:['Tree','Graph','Array','Heap'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'What is the first element in a queue called?',o:['Rear','Top','Front','Head'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'What is the last element in a queue called?',o:['Rear','Front','Top','End'],c:0,e:'Correct logic implemented.',d:'easy'},
  {q:'Which operation adds element to stack?',o:['Pop','Push','Insert','Add'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which operation removes element from stack?',o:['Delete','Remove','Pop','Push'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'Which structure uses nodes and pointers?',o:['Array','Linked List','Stack','Queue'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which is non-linear data structure?',o:['Array','Stack','Queue','Tree'],c:3,e:'Correct logic implemented.',d:'easy'},
  {q:'What is the index of first element in array?',o:['0','1','-1','Depends'],c:0,e:'Correct logic implemented.',d:'easy'},
  {q:'Which traversal visits root first?',o:['Inorder','Preorder','Postorder','Level'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which traversal visits root last?',o:['Inorder','Preorder','Postorder','Level'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'Which data structure is used for recursion?',o:['Queue','Stack','Array','Graph'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'What is a node?',o:['Data only','Pointer only','Data + pointer','Function'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'Which DS is used in BFS?',o:['Stack','Queue','Array','Tree'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which DS is used in DFS?',o:['Queue','Stack','Heap','Array'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which structure has parent-child relation?',o:['Array','Stack','Tree','Queue'],c:2,e:'Correct logic implemented.',d:'easy'},
  {q:'What is top of stack?',o:['First element','Last inserted','Middle','None'],c:1,e:'Correct logic implemented.',d:'easy'},
  {q:'Which operation checks empty stack?',o:['isEmpty','push','pop','top'],c:0,e:'Correct logic implemented.',d:'easy'},
  {q:'What is the time complexity of inserting at the beginning of a linked list?',o:['O(1)','O(n)','O(log n)','O(n log n)'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which traversal of a binary tree uses a stack (implicitly/explicitly)?',o:['BFS','DFS','Level order','None'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the average time complexity of binary search?',o:['O(n)','O(log n)','O(n log n)','O(1)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which data structure is best for implementing recursion?',o:['Queue','Stack','Heap','Graph'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'In a circular queue, when is the queue full?',o:['rear == front','(rear+1)%n == front','rear == n','front == 0'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the time complexity of deleting from the end of a singly linked list (without tail)?',o:['O(1)','O(n)','O(log n)','O(n log n)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which structure is used for priority scheduling?',o:['Stack','Queue','Priority Queue','Array'],c:2,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the worst-case height of a BST?',o:['log n','n','n log n','sqrt(n)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which hashing technique resolves collisions by probing?',o:['Chaining','Linear probing','Separate chaining','Bucketing'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the time complexity of heapify?',o:['O(1)','O(log n)','O(n)','O(n log n)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which traversal gives reverse sorted order in BST?',o:['Inorder','Preorder','Postorder','Reverse inorder'],c:3,e:'Correct logic implemented.',d:'medium'},
  {q:'Which data structure is used in undo operations?',o:['Queue','Stack','Tree','Graph'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the space complexity of adjacency list?',o:['O(V^2)','O(V+E)','O(E^2)','O(V)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which sorting is in-place?',o:['Merge sort','Quick sort','Counting sort','Radix sort'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the time complexity of enqueue in queue?',o:['O(1)','O(n)','O(log n)','O(n log n)'],c:0,e:'Correct logic implemented.',d:'medium'},
  {q:'Which DS is used to check balanced parentheses?',o:['Queue','Stack','Heap','Graph'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the best case of quicksort?',o:['O(n^2)','O(n log n)','O(log n)','O(n)'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'Which tree is always balanced?',o:['BST','AVL Tree','Binary Tree','Heap'],c:1,e:'Correct logic implemented.',d:'medium'},
  {q:'What is the time complexity of searching in a hash table (average)?',o:['O(1)','O(n)','O(log n)','O(n log n)'],c:0,e:'Correct logic implemented.',d:'medium'},
